...
# from our files
from  utils import default, url_to_bucket, exists,eval_decorator
    ...
    def forward(
        ...
        for chunk_size_frac, (chunked_args, chunked_kwargs) in split_args_and_kwargs(*args, split_size=max_batch_size,
            ...
            with self.accelerator.autocast():
                # chunked args contains the conditiong and the data in that order
